<?php
/**
 * @file views-summarize-views-tablesummarized.tpl.php
 * Template to display a view as a summarized table.
 *
 * This is copied directly from views-view-table.tpl.php with the
 * summary row added.
 *
